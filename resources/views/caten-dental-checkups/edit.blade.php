    ...
    <div class="py-6">
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Edit Pemeriksaan Gigi Caten</h2>
                    <p class="text-sm text-gray-500 mt-1">Edit data pemeriksaan gigi caten</p>
                </div>
                ...
                <form method="POST" action="{{ route('caten-dental-checkups.update', $catenDentalCheckup) }}">
                    ...
                    <div class="px-6 py-4 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="hidden" name="pasien_id" value="{{ $catenDentalCheckup->pasien->id }}">
                                <input type="text" readonly
                                    value="{{ $catenDentalCheckup->pasien->nama }} ( NIK: {{ $catenDentalCheckup->pasien->nik }}, {{ \Carbon\Carbon::parse($catenDentalCheckup->pasien->tanggal_lahir)->age }} tahun )"
                                    class="block w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm bg-gray-50 text-gray-700 sm:text-sm">
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Gigi Berlubang</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_berlubang" value="Ya"
                                                {{ old('gigi_berlubang', $catenDentalCheckup->gigi_berlubang) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_berlubang" value="Tidak"
                                                {{ old('gigi_berlubang', $catenDentalCheckup->gigi_berlubang) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                ...
                                <!-- Riwayat Sakit Gigi -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Riwayat Sakit Gigi</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="riwayat_sakit_gigi" value="Ya"
                                                {{ old('riwayat_sakit_gigi', $catenDentalCheckup->riwayat_sakit_gigi) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="riwayat_sakit_gigi" value="Tidak"
                                                {{ old('riwayat_sakit_gigi', $catenDentalCheckup->riwayat_sakit_gigi) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gusi_bengkak" value="Ya"
                                                {{ old('gusi_bengkak', $catenDentalCheckup->gusi_bengkak) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gusi_bengkak" value="Tidak"
                                                {{ old('gusi_bengkak', $catenDentalCheckup->gusi_bengkak) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Sisa Akar -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Sisa Akar</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="sisa_akar" value="Ya"
                                                {{ old('sisa_akar', $catenDentalCheckup->sisa_akar) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="sisa_akar" value="Tidak"
                                                {{ old('sisa_akar', $catenDentalCheckup->sisa_akar) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Gusi Berdarah -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Gusi Berdarah</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gusi_berdarah" value="Ya"
                                                {{ old('gusi_berdarah', $catenDentalCheckup->gusi_berdarah) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gusi_berdarah" value="Tidak"
                                                {{ old('gusi_berdarah', $catenDentalCheckup->gusi_berdarah) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_goyang" value="Ya"
                                                {{ old('gigi_goyang', $catenDentalCheckup->gigi_goyang) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_goyang" value="Tidak"
                                                {{ old('gigi_goyang', $catenDentalCheckup->gigi_goyang) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Sariawan -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Sariawan</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="sariawan" value="Ya"
                                                {{ old('sariawan', $catenDentalCheckup->sariawan) == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="sariawan" value="Tidak"
                                                {{ old('sariawan', $catenDentalCheckup->sariawan) == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            <label for="terakhir_sakit_gigi" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Terakhir Sakit Gigi</label>
                            <input type="date" name="terakhir_sakit_gigi" id="terakhir_sakit_gigi" value="{{ old('terakhir_sakit_gigi', $catenDentalCheckup->terakhir_sakit_gigi) }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="kondisi_karies" id="kondisi_karies" value="1"
                                        {{ old('kondisi_karies', $catenDentalCheckup->kondisi_karies) ? 'checked' : '' }}
                                ...
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="kondisi_sisa_akar" id="kondisi_sisa_akar" value="1"
                                        {{ old('kondisi_sisa_akar', $catenDentalCheckup->kondisi_sisa_akar) ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                ...
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="kondisi_karang_gigi" id="kondisi_karang_gigi" value="1"
                                        {{ old('kondisi_karang_gigi', $catenDentalCheckup->kondisi_karang_gigi) ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                ...
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="kondisi_gusi_bengkak" id="kondisi_gusi_bengkak" value="1"
                                        {{ old('kondisi_gusi_bengkak', $catenDentalCheckup->kondisi_gusi_bengkak) ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                ...
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="kondisi_gigi_goyang" id="kondisi_gigi_goyang" value="1"
                                        {{ old('kondisi_gigi_goyang', $catenDentalCheckup->kondisi_gigi_goyang) ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                ...
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="kondisi_pendarahan" id="kondisi_pendarahan" value="1"
                                        {{ old('kondisi_pendarahan', $catenDentalCheckup->kondisi_pendarahan) ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            ...
                            <div class="mb-5">
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="saran_konsultasi" id="saran_konsultasi" value="Ya"
                                        {{ old('saran_konsultasi', $catenDentalCheckup->saran_konsultasi) == 'Ya' ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            ...
                            <div class="mb-5">
                                <div class="flex items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    <input type="checkbox" name="saran_kontrol_rutin" id="saran_kontrol_rutin" value="Ya"
                                        {{ old('saran_kontrol_rutin', $catenDentalCheckup->saran_kontrol_rutin) == 'Ya' ? 'checked' : '' }}
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            ...
                            <div>
                                ...
                                <textarea name="catatan" id="catatan" rows="4"
                                    ...
                                    placeholder="Tambahkan catatan tambahan">{{ old('catatan', $catenDentalCheckup->catatan) }}</textarea>
                                @error('catatan')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
