                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="space-y-2 max-w-[200px]">
                                            ...
                                            @if(!$checkup->kondisi_karies && !$checkup->kondisi_sisa_akar && !$checkup->kondisi_karang_gigi && !$checkup->kondisi_gigi_goyang)
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-2">
                                            {{-- WhatsApp Button --}}
                                            <a href="{{ route('school-child-dental-checkups.whatsapp', $checkup->id) }}" 
                                            ...
                                            {{-- Print Button --}}
                                            <a href="{{ route('school-child-dental-checkups.print', $checkup->id) }}" 
                                            ...
                                            {{-- Edit Button --}}
                                            <a href="{{ route('school-child-dental-checkups.edit', $checkup->id) }}" 
                                            ...
                                            {{-- Delete Button --}}
                                            <form action="{{ route('school-child-dental-checkups.destroy', $checkup->id) }}" method="POST" 
