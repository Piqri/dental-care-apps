    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Detail Pemeriksaan Gigi Anak Sekolah</h1>
                    <p class="text-gray-600 mt-1">Informasi lengkap pemeriksaan kesehatan gigi dan mulut</p>
                </div>
                <div class="flex space-x-2">
                    <!-- Tombol WhatsApp -->
                    <button onclick="sendToWhatsApp(
                        '{{ $schoolChildDentalCheckup->pasien->nama }}',
                        '{{ $schoolChildDentalCheckup->pasien->no_wa }}',
                        {
                            kondisi_karies: {{ $schoolChildDentalCheckup->kondisi_karies ? 'true' : 'false' }},
                            kondisi_karang_gigi: {{ $schoolChildDentalCheckup->kondisi_karang_gigi ? 'true' : 'false' }},
                            kondisi_gigi_goyang: {{ $schoolChildDentalCheckup->kondisi_gigi_goyang ? 'true' : 'false' }},
                            kondisi_sisa_akar: {{ $schoolChildDentalCheckup->kondisi_sisa_akar ? 'true' : 'false' }},
                        },
                        '{{ $schoolChildDentalCheckup->jumlah_gigi }}',
                        '{{ $schoolChildDentalCheckup->saran_konsultasi }}',
                        '{{ $schoolChildDentalCheckup->saran_kontrol_rutin }}'
                    )"
                    ...
                    <a href="{{ route('school-child-dental-checkups.print', $schoolChildDentalCheckup->id) }}" target="_blank"
                    ...
                    <a href="{{ route('school-child-dental-checkups.edit', $schoolChildDentalCheckup->id) }}"
                    ...
                    <a href="{{ route('school-child-dental-checkups.index') }}"
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gray-50 px-6 py-6 border-b border-gray-200">
                    <div class="flex items-center space-x-6">
                        ...
                        <!-- Patient Info -->
                        <div class="flex-1">
                            <h2 class="text-xl font-bold text-gray-900 leading-tight mb-2">{{ $schoolChildDentalCheckup->pasien->nama }}</h2>
                            <div class="flex flex-wrap items-center gap-4 text-gray-600 text-sm">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <a href="https://wa.me/{{ $schoolChildDentalCheckup->pasien->no_wa }}" target="_blank" class="hover:underline flex items-center gap-1">
                                        {{ $schoolChildDentalCheckup->pasien->no_wa }}
                                ...
                                @endif
                                @if($schoolChildDentalCheckup->pasien->jenis_pasien)
                                <div>
                                    <span class="px-3 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-800">
                                        {{ ucfirst(str_replace('_', ' ', $schoolChildDentalCheckup->pasien->jenis_pasien)) }}
                                    </span>
                                </div>
                                @endif
                            </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4 text-sm">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="font-medium text-gray-800">{{ $schoolChildDentalCheckup->pasien->jenis_kelamin }}</p>
                            </div>
                            @endif
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="font-medium text-gray-800">
                                    {{ $schoolChildDentalCheckup->pasien->tempat_lahir }}, {{ \Carbon\Carbon::parse($schoolChildDentalCheckup->pasien->tanggal_lahir)->translatedFormat('d F Y') }}
                                </p>
                            </div>
                            @endif
                        </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4 text-sm">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="font-medium text-gray-800">{{ $schoolChildDentalCheckup->pasien->nik }}</p>
                            </div>
                            @endif
                            <div class="space-y-1">
                                <p class="text-xs text-gray-500 uppercase">Tanggal Pemeriksaan</p>
                                <p class="font-medium text-gray-800">{{ $schoolChildDentalCheckup->created_at->format('d F Y H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="px-6 py-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- Jumlah Gigi -->
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <span class="text-sm font-medium text-gray-700">Jumlah Gigi</span>
                            <span class="px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                {{ ucfirst($schoolChildDentalCheckup->jumlah_gigi) }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-6">
                    <div class="space-y-6">
                        ...
                        <div class="p-4 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <p class="text-blue-900 whitespace-pre-wrap">{{ $schoolChildDentalCheckup->catatan }}</p>
                        </div>
                        @endif
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 text-center">
                            <p class="text-gray-500 italic">Tidak ada saran atau catatan</p>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="px-6 py-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="font-medium text-gray-800">{{ $schoolChildDentalCheckup->updated_at->format('d F Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
