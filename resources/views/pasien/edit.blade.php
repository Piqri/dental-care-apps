        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Edit data pasien sesuai dengan jenis pasien</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('pasien.update', $pasien->id) }}" id="pasienForm">
                        ...
                        <div class="mb-8">
                            ...
                            <select name="jenis_pasien" id="jenis_pasien"
                                class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm h-[37px] px-3 py-2 bg-gray-100"
                                disabled>
                                <option value="">-- Pilih Jenis Pasien --</option>
                                <option value="ibu_hamil" {{ $pasien->jenis_pasien == 'ibu_hamil' ? 'selected' : '' }}>Ibu Hamil</option>
                                <option value="anak_sekolah" {{ $pasien->jenis_pasien == 'anak_sekolah' ? 'selected' : '' }}>Anak Sekolah</option>
                                <option value="caten" {{ $pasien->jenis_pasien == 'caten' ? 'selected' : '' }}>CATEN (Dewasa)</option>
                            </select>
                            <input type="hidden" name="jenis_pasien" value="{{ $pasien->jenis_pasien }}">
                            @error('jenis_pasien')
                        ...
                        <div id="formContainer" class="space-y-6">
                            ...
                            <div id="dynamicFields" class="space-y-6">
                                <!-- Ibu Hamil Fields -->
                                <div id="ibu_hamil_fields" class="jenis-pasien-fields {{ $pasien->jenis_pasien != 'ibu_hamil' ? 'hidden' : '' }} space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input type="text" name="nik" id="nik_ibu_hamil" value="{{ old('nik', $pasien->nik) }}"
                                ...
                                <!-- Anak Sekolah Fields -->
                                <div id="anak_sekolah_fields" class="jenis-pasien-fields {{ $pasien->jenis_pasien != 'anak_sekolah' ? 'hidden' : '' }} space-y-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                ...
                                <!-- CATEN Fields -->
                                <div id="caten_fields" class="jenis-pasien-fields {{ $pasien->jenis_pasien != 'caten' ? 'hidden' : '' }} space-y-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label for="nik_caten" class="text-sm font-medium text-gray-700">
                                                NIK <span class="text-red-500">*</span>
                                            </label>
                                            <input type="text" name="nik" id="nik_caten" value="{{ old('nik', $pasien->nik) }}"
                                                inputmode="numeric" pattern="\d*"
                                                maxlength="16"
                                                oninput="this.value = this.value.replace(/\D/g, '').slice(0,16);"
                                                class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
