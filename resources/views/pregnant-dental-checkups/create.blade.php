<x-app-layout>
    <div class="py-6">
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Tambah Pemeriksaan Gigi Ibu Hamil Baru</h2>
                    <p class="text-sm text-gray-500 mt-1">Isi form berikut untuk menambahkan data pemeriksaan gigi ibu hamil</p>
                </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <!-- Form Section -->
                <form method="POST" action="{{ route('pregnant-dental-checkups.store') }}">
                    @csrf
                    <div class="px-6 py-4 space-y-6">
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah gigi ibu berdarah?</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_berdarah" value="Ya"
                                                {{ old('gigi_berdarah') == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_berdarah" value="Tidak"
                                                {{ old('gigi_berdarah', 'Tidak') == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                ...
                                <!-- Gusi Bengkak -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah gusi ibu ada bengkak? </label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                ...
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah ada orang lain yg mengatakan ibu bau mulut? </label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="dikomentari_bau_mulut" value="Ya"
                                                {{ old('dikomentari_bau_mulut') == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="dikomentari_bau_mulut" value="Tidak"
                                                {{ old('dikomentari_bau_mulut', 'Tidak') == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Gigi Goyang -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah ibu merasa giginya goyang/akan lepas?</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                ...
                                <!-- Sulit Mengunyah -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah ibu kesulitan mengunyah/makan yg keras?</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="sulit_mengunyah" value="Ya"
                                                {{ old('sulit_mengunyah') == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="sulit_mengunyah" value="Tidak"
                                                {{ old('sulit_mengunyah', 'Tidak') == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Makanan Terselip -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah makanan sering terselip di antara gigi?</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="makanan_terselip" value="Ya"
                                                {{ old('makanan_terselip') == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="makanan_terselip" value="Tidak"
                                                {{ old('makanan_terselip', 'Tidak') == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Gusi Sakit -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah ada gusi ibu yang sakit?</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gusi_sakit" value="Ya"
                                                {{ old('gusi_sakit') == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gusi_sakit" value="Tidak"
                                                {{ old('gusi_sakit', 'Tidak') == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                                ...
                                <!-- Gigi Sakit -->
                                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <label class="block text-sm font-medium text-gray-700 mb-3">Apakah ada gigi ibu yang sakit?</label>
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_sakit" value="Ya"
                                                {{ old('gigi_sakit') == 'Ya' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Ya</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="gigi_sakit" value="Tidak"
                                                {{ old('gigi_sakit', 'Tidak') == 'Tidak' ? 'checked' : '' }}
                                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                            <span class="ml-2 text-sm text-gray-700">Tidak</span>
                                        </label>
                                    </div>
                        ...
                        <!-- Keluhan Lain -->
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            <label for="keluhan_lain" class="block text-sm font-medium text-gray-700 mb-2">Apakah ibu ada keluhan lain?</label>
                            <input type="text" name="keluhan_lain" id="keluhan_lain" value="{{ old('keluhan_lain') }}"
    ...
    <script>
        const pasienSearchUrl = "{{ route('ajax.pasien-search') }}";
    </script>

    <script src="{{ asset('app/patients-search.js') }}"></script>
</x-app-layout>
