    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Detail Pemeriksaan Gigi Ibu Hamil</h1>
                ...
                <div class="flex space-x-2">
                    ...
                    <button onclick="sendToWhatsApp(
                        '{{ $pregnantDentalCheckup->pasien->nama }}',
                        '{{ $pregnantDentalCheckup->pasien->no_wa }}',
                        {
                            kondisi_karies: {{ $pregnantDentalCheckup->kondisi_karies ? 'true' : 'false' }},
                            kondisi_sisa_akar: {{ $pregnantDentalCheckup->kondisi_sisa_akar ? 'true' : 'false' }},
                            kondisi_karang_gigi: {{ $pregnantDentalCheckup->kondisi_karang_gigi ? 'true' : 'false' }},
                            kondisi_gusi_bengkak: {{ $pregnantDentalCheckup->kondisi_gusi_bengkak ? 'true' : 'false' }},
                            kondisi_gigi_goyang: {{ $pregnantDentalCheckup->kondisi_gigi_goyang ? 'true' : 'false' }},
                            kondisi_pendarahan: {{ $pregnantDentalCheckup->kondisi_pendarahan ? 'true' : 'false' }},
                        },
                        '{{ $pregnantDentalCheckup->saran_konsultasi }}',
                        '{{ $pregnantDentalCheckup->saran_kontrol_rutin }}'
                    )"
                    class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md">
                        Kirim ke WA
                    </button>
                    <a href="{{ route('pregnant-dental-checkups.print', $pregnantDentalCheckup->id) }}" target="_blank"
                    ...
                    <a href="{{ route('pregnant-dental-checkups.edit', $pregnantDentalCheckup->id) }}"
                    ...
                    <a href="{{ route('pregnant-dental-checkups.index') }}"
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gray-50 px-6 py-6 border-b border-gray-200">
                    <div class="flex items-center space-x-6">
                        ...
                        <!-- Patient Info -->
                        <div class="flex-1">
                            <h2 class="text-xl font-bold text-gray-900 leading-tight mb-2">{{ $pregnantDentalCheckup->pasien->nama }}</h2>
                            <div class="flex flex-wrap items-center gap-4 text-gray-600 text-sm">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <a href="https://wa.me/{{ $pregnantDentalCheckup->pasien->no_wa }}" target="_blank" class="hover:underline flex items-center gap-1">
                                        {{ $pregnantDentalCheckup->pasien->no_wa }}
                                ...
                                <div class="flex items-center gap-1">
                                    <span class="inline-flex items-center justify-center bg-gray-200 text-gray-700 rounded-full h-6 w-6 mr-1">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 极 3 3 0 016 0z" />
                                        </svg>
                                    </span>
                                ...
                                <div>
                                    <span class="px-3 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-800">
                                        {{ ucfirst(str_replace('_', ' ', $pregnantDentalCheckup->pasien->jenis_pasien)) }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4 text-sm">
                            <div class="space-y-1">
                                ...
                                <p class="font-medium text-gray-800">{{ $pregnantDentalCheckup->pasien->jenis_kelamin }}</p>
                            </div>
                            <div class="space-y-1">
                                <p class="text-xs text-gray-500 uppercase">Tanggal Lahir</p>
                                <p class="font-medium text-gray-800">
                                    {{ $pregnantDentalCheckup->pasien->tempat_lahir }}, {{ \Carbon\Carbon::parse($pregnantDentalCheckup->pasien->tanggal_lahir)->translatedFormat('d F Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4 text-sm">
                            <div class="space-y-1">
                                ...
                                <p class="font-medium text-gray-800">{{ $pregnantDentalCheckup->pasien->nik }}</p>
                            </div>
                            <div class="space-y-1">
                                <p class="text-xs text-gray-500 uppercase">Tanggal Pemeriksaan</p>
                                <p class="font-medium text-gray-800">{{ $pregnantDentalCheckup->created_at->format('d F Y H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <span class="px-3 py-1 rounded-full text-xs font-medium {{ $pregnantDentalCheckup->$field == 'Ya' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                    ...
                    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <p class="text-sm font-medium text-blue-800 mb-2">Keluhan Lain:</p>
                        <p class="text-blue-900">{{ $pregnantDentalCheckup->keluhan_lain }}</p>
                    </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div>
                                ...
                                <p class="text-green-700">Disarankan untuk melakukan kontrol rutin 6x sekali</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="p-4 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <p class="text-blue-900 whitespace-pre-wrap">{{ $pregnantDentalCheckup->catatan }}</p>
                        </div>
                        @endif
                ...
                <div class="px-6 py-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="font-medium text-gray-800">{{ $pregnantDentalCheckup->updated_at->format('d F Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
